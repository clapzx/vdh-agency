...
function serviceJsonLd(locale: string) {
  ...
  return {
    ...
    '@graph': [
      {
        '@type': 'Service',
        name: isNl ? 'Website Maken' : 'Website Development',
...
export async function generateMetadata({
  ...
  return {
    title: isNl
      ? 'Website Laten Maken, Snel, SEO-proof & op maat'
      : 'Have a Website Built, Fast, SEO-proof & custom',
    description: isNl
...
export default async function WebsiteMakenPage({
  params,
}: {
  params: Promise<{locale: string}>;
}) {
