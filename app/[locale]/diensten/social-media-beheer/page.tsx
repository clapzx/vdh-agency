...
export async function generateMetadata({
  ...
  return {
    ...
    description: isNl
      ...
      : 'VDH Agency fully takes over your social media: strategy, on-location filming, professional video editing and weekly publishing. For Instagram, LinkedIn, Facebook and TikTok.',
    alternates: {
