...
export async function generateMetadata({
  ...
  return {
    ...
    description: isNl
      ? 'Marketing bureau uit Heerde, actief door heel Nederland. VDH Agency helpt MKB-bedrijven via SEO, Google Ads, social media en webdesign. Plan een gratis consult.'
